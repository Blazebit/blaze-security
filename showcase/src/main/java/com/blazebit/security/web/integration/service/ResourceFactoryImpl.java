...
public class ResourceFactoryImpl implements EntityResourceFactory {
	...
	@Override
	public EntityObjectField createResource(String entity, String field,
			Integer id) {
		return new EntityObjectField(entity, field, String.valueOf(id));
	}

	@Override
	public AbstractEntityField createResource(Class<?> clazz, String field,
			Integer id) {
	...
	public EntityField createResource(Class<?> clazz, Integer id) {
		return (EntityField) createResource(clazz, EntityField.EMPTY_FIELD, id);

	}

	@Override
	public EntityField createResource(IdHolder entityObject) {
		return (EntityField) createResource(entityObject.getClass(),
				EntityField.EMPTY_FIELD, entityObject.getId());
	}

	@Override
	public EntityField createResource(IdHolder entityObject, String field) {
		return (EntityField) createResource(entityObject.getClass(), field,
				entityObject.getId());
	}
