...
public class TestServerAuthConfig implements ServerAuthConfig {
    ...
    /**
     * WebLogic 12c, JBoss EAP 6 and GlassFish 3.1.2.2 call this only once per request, Geronimo V3 calls this before
     * sam.validateRequest and again before sam.secureRequest in the same request.
     * 
     */
    @Override
