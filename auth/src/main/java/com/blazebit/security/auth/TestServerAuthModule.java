...
public class TestServerAuthModule implements ServerAuthModule {
    ...
    public AuthStatus validateRequest(MessageInfo messageInfo, Subject clientSubject, Subject serviceSubject) throws AuthException {
        ...
        if (userContext.getUser() != null) {
            ...
            CallerPrincipalCallback callerPrincipalCallback = new CallerPrincipalCallback(clientSubject, userContext.getUser().getUsername());
            List<String> resourceNames = permissionManager.getPermissionResources(userContext.getUser());
