...
/**
 * If annotated on class level, no test method will get a fresh database.
 * On method level this annotation will only affect the respective test method.
 * The behavior on class level can be overridden by using {@link DatabaseAware} on specific methods.
...
public @interface DatabaseUnaware {
