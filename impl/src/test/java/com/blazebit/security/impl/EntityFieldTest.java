...
public class EntityFieldTest extends BaseTest<EntityFieldTest> {
    ...
    public void test_child_relation_of_entityField() {
        assertEquals(documentEntity.getChild("title"), documentEntityTitleField);
        assertEquals(documentEntity.getChild("content"), documentEntityContentField);
    }

    @Test
    public void test_child_relation_of_entityField_false() {
        assertNotEquals(documentEntity.getChild("title"), documentEntityContentField);
        assertNotEquals(documentEntity.getChild("content"), documentEntity);
    }
    ...
    public void test_child_relation_of_entityObjectField() {
        assertEquals(document1Entity.getChild("title"), document1EntityTitleField);
    }
    ...
    public void test_isEmtptyField_entity() {
        assertTrue(documentEntity.isEmptyField());
    }

    @Test
    public void test_isEmtptyField_entityObject() {
        assertTrue(document1Entity.isEmptyField());
    }

    @Test
    public void test_isEmtptyField_entity_field_false() {
        assertFalse(documentEntityTitleField.isEmptyField());
    }

    @Test
    public void test_isEmtptyField_entityObject_field_false() {
        assertFalse(document1EntityTitleField.isEmptyField());
    }
