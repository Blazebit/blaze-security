...
public class PermissionServiceTest extends BaseTest<PermissionServiceTest> {
    ...
    public void test_grant_permission_to_role_propagate_to_users4() {
        ...
        permissionService.grant(admin, user1, readAction, documentEntity.getChild("content"));
        permissionService.grant(admin, user1, readAction, documentEntity.getChild("title"));
        permissionService.grant(admin, user1, readAction, documentEntity.getChild("size"));

        permissionService.grant(admin, userGroupA, readAction, documentEntity.getChild("id"), true);
        assertTrue(permissionService.isGranted(user1, readAction, documentEntity));
    }
    ...
    public void test_grant_permission_to_role_propagate_to_users6() {
        ...
        permissionService.grant(admin, userGroupA, readAction, documentEntity.getChild("content"), true);
        assertTrue(permissionService.isGranted(user1, readAction, documentEntity));
    }
    ...
    public void test_revoke_permission_to_role_propagate_to_users3() {
        ...
        assertTrue(permissionService.isGranted(user1, readAction, documentEntity.getChild("size")));
        assertTrue(permissionService.isGranted(user1, readAction, documentEntity.getChild("id")));
    }
    ...
    public void test_revoke_permission_to_role_propagate_to_users6() {
        ...
        permissionService.grant(admin, userGroupA, readAction, documentEntity.getChild("content"));
        permissionService.grant(admin, userGroupA, readAction, documentEntity.getChild("title"));
        permissionService.grant(admin, userGroupA, readAction, documentEntity.getChild("size"));

        assertTrue(permissionService.isGranted(userGroupA, readAction, documentEntity.getChild("content")));
        assertTrue(permissionService.isGranted(userGroupA, readAction, documentEntity.getChild("title")));
        assertTrue(permissionService.isGranted(userGroupA, readAction, documentEntity.getChild("size")));

        permissionService.grant(admin, user1, readAction, documentEntity.getChild("title"));
        permissionService.grant(admin, user1, readAction, documentEntity.getChild("id"));

        permissionService.revoke(admin, userGroupA, readAction, documentEntity.getChild("content"), true);
        permissionService.revoke(admin, userGroupA, readAction, documentEntity.getChild("title"), true);
