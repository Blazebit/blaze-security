...
public abstract class AbstractPermission<S, P extends PermissionId<S>> implements Permission, Serializable {
    ...
    public boolean matches(Permission _permission) {
        ...
        return this.id.getEntity().equals(permission.id.getEntity()) && this.id.getField().equals(permission.id.getField()) && this.id.getActionName().equals(permission.id.getActionName());
    }
}