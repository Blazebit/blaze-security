 ...
 * @author Christian
 */
public abstract class AbstractEntityObjectField extends AbstractEntityField implements EntityDataResource {
    ...
    public abstract EntityDataResource withField(String field);

	public abstract EntityDataResource withEntityId(String entityId);
