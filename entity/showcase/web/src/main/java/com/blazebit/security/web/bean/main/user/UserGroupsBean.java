...
public class UserGroupsBean extends GroupHandlingBaseBean {
    ...
    private void initUserPermissions() {
        ...
        List<List<Permission>> permissions = EntityPermissionUtils.getSeparatedPermissionsByResource(allPermissions);
        userPermissions = permissions.get(0);
        userDataPermissions = permissions.get(1);
        this.permissionViewRoot = getImmutablePermissionTree(userPermissions, userDataPermissions, !isEnabled(Features.FIELD_LEVEL));
    }
