...
public class StartupBean {
    ...
    public void startup() {
        if (companyService.findCompanies().isEmpty()) {
            //
            Action grantAction = actionFactory.createAction(Action.GRANT);
            Action revokeAction = actionFactory.createAction(Action.REVOKE);
            Action createAction = actionFactory.createAction(Action.CREATE);
            ...
            Action addAction = actionFactory.createAction(Action.ADD);
            Action removeAction = actionFactory.createAction(Action.REMOVE);
            ...
            for (EntityResourceDefinition def : metamodel.getResourceDefinitions().keySet()) {
